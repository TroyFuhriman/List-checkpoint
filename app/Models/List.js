...
export default class List {
  ...
  get Template() {
    ...
    <div class="card shadow">
      <div class="card-top text-center bg-secondary text-light d-flex flex-column"
        ...
        <i onclick="app.itemsController.deleteList('${this.id}')" class="fas fa-minus-square text-warning align-self-end pr-1 pt-1 hover" aria-hidden="true"></i>
        <h5>${this.title} </h5>
      </div>
      <div class="card-body">
  ...
  get ItemsTemplate() {
    ...
    this.items.forEach((item, index) => {
      ...
      onclick= "app.itemsController.deleteItem('${this.id}', ${index})"
            aria-hidden="true"></i>`
    })
    return template;
  }
